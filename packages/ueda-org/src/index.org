...
I use [[https://github.com/x-motemen/ghq][ghq]] for remote repository management. I make it integrate it with =project.el= project switcher like this:

#+begin_src emacs-lisp
  (use-package
    project
    :config
    ;; Populate the project switcher list fr `ghq`
    (dolist
      (project

...
(setq org-static-blog-index-front-matter
  (org-static-blog-render-post-content (concat (file-name-as-directory base-dir) "index.org")))
...
(defun blog-post-list-item (post)
  (concat
    ...
    (format-time-string (org-static-blog-gettext 'date-format) (org-static-blog-get-date post))
    "</span> "
    "<a href=\""
    (org-static-blog-get-post-url post)
    "\">"
    (org-static-blog-get-title post)
    "</a></li>\n"))

(defun blog-post-list (posts)
  (concat "<ul class=\"post-list\">" (apply 'concat (mapcar #'blog-post-list-item posts)) "</ul>"))

(defun blog-post-list-newest-first (posts)
  (blog-post-list
    (sort
      posts
      (lambda (x y) (time-less-p (org-static-blog-get-date y) (org-static-blog-get-date x))))))
  ...
  (let
    ...
    (org-static-blog-with-find-file
      ...
      (org-static-blog-template
        ...
        (concat org-static-blog-index-front-matter (blog-post-list post-filenames))))))
...
(defun org-static-blog-assemble-tags ()
  ...
  (dolist
    (tag (org-static-blog-get-tag-tree))
    (org-static-blog-with-find-file
      (concat-to-dir
...
(setq org-static-blog-page-header
  (concat
    ...
    (mapconcat
      (lambda (file) (format "<link rel=\"prefetch\" href=\"%s\" />\n" file))
      (append
        (list
        ...
        (mapcar #'org-static-blog-get-post-public-path (org-static-blog-get-post-filenames)))
      "")))
...
<a href=\"https://%s\">%s</a>
    ...
    publish-domain org-static-blog-publish-title))

// https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/resources/load_balancer_pool
...
export class LoadBalancerPool extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LoadBalancerPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/resources/load_balancer_pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/resources/load_balancer_pool cloudflare_load_balancer_pool} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      health_sources: cdktf.listMapper(cdktf.stringToTerraform, false)(this._healthSources),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      health_sources: {
        value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(this._healthSources),
        isBlock: false,
        type: "list",
        storageClassType: "stringList",
      },

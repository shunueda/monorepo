// https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/data-sources/ruleset
...
export interface DataCloudflareRulesetConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/data-sources/ruleset#account_id DataCloudflareRuleset#account_id}
  */
  readonly accountId?: string;
  /**
  * The unique ID of the ruleset.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/data-sources/ruleset#id DataCloudflareRuleset#id}
  *
  ...
  * The unique ID of the ruleset.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/data-sources/ruleset#ruleset_id DataCloudflareRuleset#ruleset_id}
  */
  readonly rulesetId?: string;
  /**
  * The unique ID of the zone.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/data-sources/ruleset#zone_id DataCloudflareRuleset#zone_id}
  */
...
export interface DataCloudflareRulesetRulesActionParametersOriginRangeRequests {
}

export function dataCloudflareRulesetRulesActionParametersOriginRangeRequestsToTerraform(struct?: DataCloudflareRulesetRulesActionParametersOriginRangeRequests): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataCloudflareRulesetRulesActionParametersOriginRangeRequestsToHclTerraform(struct?: DataCloudflareRulesetRulesActionParametersOriginRangeRequests): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataCloudflareRulesetRulesActionParametersOriginRangeRequestsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataCloudflareRulesetRulesActionParametersOriginRangeRequests | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataCloudflareRulesetRulesActionParametersOriginRangeRequests | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataCloudflareRulesetRulesActionParametersVaryDefaultOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareRulesetRulesActionParametersVaryHeadersOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareRulesetRulesActionParametersVaryHeadersMap extends cdktf.ComplexMap {
...
export class DataCloudflareRulesetRulesActionParametersVaryOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareRulesetRulesActionParametersOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // origin_range_requests - computed: true, optional: false, required: false
  private _originRangeRequests = new DataCloudflareRulesetRulesActionParametersOriginRangeRequestsOutputReference(this, "origin_range_requests");
...
/**
* Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/data-sources/ruleset cloudflare_ruleset}
*/
export class DataCloudflareRuleset extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareRuleset that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/data-sources/ruleset#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/data-sources/ruleset cloudflare_ruleset} Data Source
  *
  * @param scope The scope in which to define this construct

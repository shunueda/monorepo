// https://registry.terraform.io/providers/cloudflare/cloudflare/5.24.0/docs/data-sources/flagship_flag
...
export class DataCloudflareFlagshipFlag extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareFlagshipFlag that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.24.0/docs/data-sources/flagship_flag#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.24.0/docs/data-sources/flagship_flag cloudflare_flagship_flag} Data Source
  *
  * @param scope The scope in which to define this construct

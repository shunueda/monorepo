...
export class DataCloudflareZeroTrustDeviceDefaultProfileDnsSearchSuffixesOutputReference extends cdktf.ComplexObject {
...
export class DataCloudflareZeroTrustDeviceDefaultProfileDnsSearchSuffixesList extends cdktf.ComplexList {
...
export class DataCloudflareZeroTrustDeviceDefaultProfileVirtualNetworksOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;

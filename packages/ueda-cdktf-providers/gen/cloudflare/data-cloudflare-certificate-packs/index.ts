// https://registry.terraform.io/providers/cloudflare/cloudflare/5.22.0/docs/data-sources/certificate_packs
...
export class DataCloudflareCertificatePacksResultDcvDelegationRecordsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataCloudflareCertificatePacksResultDcvDelegationRecords | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataCloudflareCertificatePacksResultDcvDelegationRecords | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataCloudflareCertificatePacksResultDcvDelegationRecordsList extends cdktf.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataCloudflareCertificatePacksResultDcvDelegationRecordsOutputReference {
...
export class DataCloudflareCertificatePacksResultOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _dcvDelegationRecords = new DataCloudflareCertificatePacksResultDcvDelegationRecordsList(this, "dcv_delegation_records", false);
...
export class DataCloudflareCertificatePacks extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareCertificatePacks that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.22.0/docs/data-sources/certificate_packs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.22.0/docs/data-sources/certificate_packs cloudflare_certificate_packs} Data Source
  *
  * @param scope The scope in which to define this construct

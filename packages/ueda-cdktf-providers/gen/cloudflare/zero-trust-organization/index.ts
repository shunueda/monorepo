// https://registry.terraform.io/providers/cloudflare/cloudflare/5.24.0/docs/resources/zero_trust_organization
...
export interface ZeroTrustOrganizationConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  readonly warpAuthNonBrowser401?: boolean | cdktf.IResolvable;
  /**
...
export class ZeroTrustOrganization extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ZeroTrustOrganization that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.24.0/docs/resources/zero_trust_organization#import import section} in the documentation of this resource for the id to use
  ...
  */
  public constructor(scope: Construct, id: string, config: ZeroTrustOrganizationConfig = {}) {
    ...
    this._warpAuthNonBrowser401 = config.warpAuthNonBrowser401;
  ...
  // warp_auth_non_browser_401 - computed: true, optional: true, required: false
  private _warpAuthNonBrowser401?: boolean | cdktf.IResolvable; 
  public get warpAuthNonBrowser401() {
    return this.getBooleanAttribute('warp_auth_non_browser_401');
  }
  public set warpAuthNonBrowser401(value: boolean | cdktf.IResolvable) {
    this._warpAuthNonBrowser401 = value;
  }
  public resetWarpAuthNonBrowser401() {
    this._warpAuthNonBrowser401 = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get warpAuthNonBrowser401Input() {
    return this._warpAuthNonBrowser401;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      warp_auth_non_browser_401: cdktf.booleanToTerraform(this._warpAuthNonBrowser401),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      warp_auth_non_browser_401: {
        value: cdktf.booleanToHclTerraform(this._warpAuthNonBrowser401),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },

...
export interface DataCloudflareEmailSecurityAllowPoliciesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Identifier.
  *
...
export interface DataCloudflareEmailSecurityAllowPoliciesResult {
}

export function dataCloudflareEmailSecurityAllowPoliciesResultToTerraform(struct?: DataCloudflareEmailSecurityAllowPoliciesResult): any {
...
export function dataCloudflareEmailSecurityAllowPoliciesResultToHclTerraform(struct?: DataCloudflareEmailSecurityAllowPoliciesResult): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataCloudflareEmailSecurityAllowPoliciesResultOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataCloudflareEmailSecurityAllowPoliciesResult | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataCloudflareEmailSecurityAllowPoliciesResult | undefined) {
    if (value === undefined) {
...
export class DataCloudflareEmailSecurityAllowPoliciesResultList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataCloudflareEmailSecurityAllowPoliciesResultOutputReference {
    return new DataCloudflareEmailSecurityAllowPoliciesResultOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
*/
export class DataCloudflareEmailSecurityAllowPolicies extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "cloudflare_email_security_allow_policies";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DataCloudflareEmailSecurityAllowPolicies resource upon running "cdktf plan <stack-name>"
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_email_security_allow_policies", importId: importFromId, provider });
      }
  ...
  * @param options DataCloudflareEmailSecurityAllowPoliciesConfig
  */
  public constructor(scope: Construct, id: string, config: DataCloudflareEmailSecurityAllowPoliciesConfig) {
    super(scope, id, {
  ...
  private _result = new DataCloudflareEmailSecurityAllowPoliciesResultList(this, "result", false);
  public get result() {
    return this._result;
  }

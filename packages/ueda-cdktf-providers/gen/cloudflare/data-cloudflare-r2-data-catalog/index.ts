// https://registry.terraform.io/providers/cloudflare/cloudflare/5.21.0/docs/data-sources/r2_data_catalog
...
export class DataCloudflareR2DataCatalogMaintenanceConfigCompactionOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataCloudflareR2DataCatalogMaintenanceConfigCompaction | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataCloudflareR2DataCatalogMaintenanceConfigCompaction | undefined) {
    if (value === undefined) {
...
export class DataCloudflareR2DataCatalogMaintenanceConfigSnapshotExpirationOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataCloudflareR2DataCatalogMaintenanceConfigSnapshotExpiration | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataCloudflareR2DataCatalogMaintenanceConfigSnapshotExpiration | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataCloudflareR2DataCatalogMaintenanceConfigOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataCloudflareR2DataCatalogMaintenanceConfig | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataCloudflareR2DataCatalogMaintenanceConfig | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
  ...
  private _compaction = new DataCloudflareR2DataCatalogMaintenanceConfigCompactionOutputReference(this, "compaction");
  public get compaction() {
    return this._compaction;
  }

  // snapshot_expiration - computed: true, optional: false, required: false
  private _snapshotExpiration = new DataCloudflareR2DataCatalogMaintenanceConfigSnapshotExpirationOutputReference(this, "snapshot_expiration");
...
export class DataCloudflareR2DataCatalog extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareR2DataCatalog that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.21.0/docs/data-sources/r2_data_catalog#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.21.0/docs/data-sources/r2_data_catalog cloudflare_r2_data_catalog} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataCloudflareR2DataCatalogConfig
  */
  public constructor(scope: Construct, id: string, config: DataCloudflareR2DataCatalogConfig) {
    super(scope, id, {
  ...
  private _maintenanceConfig = new DataCloudflareR2DataCatalogMaintenanceConfigOutputReference(this, "maintenance_config");

// https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/resources/zero_trust_access_identity_provider
...
export interface ZeroTrustAccessIdentityProviderConfigA {
  ...
  */
  readonly maxSsoUrlLength?: number;
  /**
...
export function zeroTrustAccessIdentityProviderConfigAToTerraform(struct?: ZeroTrustAccessIdentityProviderConfigA | cdktf.IResolvable): any {
  ...
  return {
    ...
    max_sso_url_length: cdktf.numberToTerraform(struct!.maxSsoUrlLength),
...
export function zeroTrustAccessIdentityProviderConfigAToHclTerraform(struct?: ZeroTrustAccessIdentityProviderConfigA | cdktf.IResolvable): any {
  ...
  const attrs = {
    ...
    max_sso_url_length: {
      value: cdktf.numberToHclTerraform(struct!.maxSsoUrlLength),
      isBlock: false,
      type: "simple",
...
export class ZeroTrustAccessIdentityProviderConfigAOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ZeroTrustAccessIdentityProviderConfigA | cdktf.IResolvable | undefined {
    ...
    if (this._maxSsoUrlLength !== undefined) {
      hasAnyValues = true;
      internalValueResult.maxSsoUrlLength = this._maxSsoUrlLength;
    }
  ...
  public set internalValue(value: ZeroTrustAccessIdentityProviderConfigA | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      ...
      this._maxSsoUrlLength = undefined;
      ...
      this._maxSsoUrlLength = value.maxSsoUrlLength;
  ...
  // max_sso_url_length - computed: false, optional: true, required: false
  private _maxSsoUrlLength?: number; 
  public get maxSsoUrlLength() {
    return this.getNumberAttribute('max_sso_url_length');
  }
  public set maxSsoUrlLength(value: number) {
    this._maxSsoUrlLength = value;
  }
  public resetMaxSsoUrlLength() {
    this._maxSsoUrlLength = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get maxSsoUrlLengthInput() {
    return this._maxSsoUrlLength;
  }
...
export class ZeroTrustAccessIdentityProvider extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ZeroTrustAccessIdentityProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/resources/zero_trust_access_identity_provider#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/resources/zero_trust_access_identity_provider cloudflare_zero_trust_access_identity_provider} Resource
  *
  * @param scope The scope in which to define this construct

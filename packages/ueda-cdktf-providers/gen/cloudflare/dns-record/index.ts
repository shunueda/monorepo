// https://registry.terraform.io/providers/cloudflare/cloudflare/5.22.0/docs/resources/dns_record
...
export class DnsRecord extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DnsRecord that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.22.0/docs/resources/dns_record#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.22.0/docs/resources/dns_record cloudflare_dns_record} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _privateRouting?: boolean | cdktf.IResolvable; 
  public get privateRouting() {
    return this.getBooleanAttribute('private_routing');
  }
  public set privateRouting(value: boolean | cdktf.IResolvable) {
    this._privateRouting = value;
  }
  public resetPrivateRouting() {
    this._privateRouting = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get privateRoutingInput() {

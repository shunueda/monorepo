// https://registry.terraform.io/providers/cloudflare/cloudflare/5.24.0/docs/data-sources/calls_turn_apps
...
export class DataCloudflareCallsTurnApps extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareCallsTurnApps that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.24.0/docs/data-sources/calls_turn_apps#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.24.0/docs/data-sources/calls_turn_apps cloudflare_calls_turn_apps} Data Source
  *
  * @param scope The scope in which to define this construct

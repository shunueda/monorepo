// https://registry.terraform.io/providers/cloudflare/cloudflare/5.21.0/docs/data-sources/zero_trust_dlp_integration_entries
...
export class DataCloudflareZeroTrustDlpIntegrationEntriesResultConfidenceOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataCloudflareZeroTrustDlpIntegrationEntriesResultConfidence | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataCloudflareZeroTrustDlpIntegrationEntriesResultConfidence | undefined) {
    if (value === undefined) {
...
export class DataCloudflareZeroTrustDlpIntegrationEntriesResultPatternOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataCloudflareZeroTrustDlpIntegrationEntriesResultPattern | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataCloudflareZeroTrustDlpIntegrationEntriesResultPattern | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataCloudflareZeroTrustDlpIntegrationEntriesResultVariantOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataCloudflareZeroTrustDlpIntegrationEntriesResultVariant | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataCloudflareZeroTrustDlpIntegrationEntriesResultVariant | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataCloudflareZeroTrustDlpIntegrationEntriesResultOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataCloudflareZeroTrustDlpIntegrationEntriesResult | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataCloudflareZeroTrustDlpIntegrationEntriesResult | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
  ...
  private _confidence = new DataCloudflareZeroTrustDlpIntegrationEntriesResultConfidenceOutputReference(this, "confidence");
  ...
  private _pattern = new DataCloudflareZeroTrustDlpIntegrationEntriesResultPatternOutputReference(this, "pattern");
  public get pattern() {
...
export class DataCloudflareZeroTrustDlpIntegrationEntries extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "cloudflare_zero_trust_dlp_integration_entries";
  ...
  * @param importFromId The id of the existing DataCloudflareZeroTrustDlpIntegrationEntries that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.21.0/docs/data-sources/zero_trust_dlp_integration_entries#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.21.0/docs/data-sources/zero_trust_dlp_integration_entries cloudflare_zero_trust_dlp_integration_entries} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataCloudflareZeroTrustDlpIntegrationEntriesConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataCloudflareZeroTrustDlpIntegrationEntriesConfig = {}) {
    super(scope, id, {
  ...
  private _result = new DataCloudflareZeroTrustDlpIntegrationEntriesResultList(this, "result", false);
  public get result() {
    return this._result;
  }

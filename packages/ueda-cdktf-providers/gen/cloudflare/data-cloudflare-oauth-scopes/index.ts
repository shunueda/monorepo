...
export interface DataCloudflareOauthScopesConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class DataCloudflareOauthScopesResultOutputReference extends cdktf.ComplexObject {
...
export class DataCloudflareOauthScopesResultList extends cdktf.ComplexList {
...
*/
export class DataCloudflareOauthScopes extends cdktf.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a DataCloudflareOauthScopes resource upon running "cdktf plan <stack-name>"
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_oauth_scopes", importId: importFromId, provider });
      }

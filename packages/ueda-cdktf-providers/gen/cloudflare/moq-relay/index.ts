// https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/resources/moq_relay
...
export class MoqRelay extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MoqRelay that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/resources/moq_relay#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/resources/moq_relay cloudflare_moq_relay} Resource
  *
  * @param scope The scope in which to define this construct

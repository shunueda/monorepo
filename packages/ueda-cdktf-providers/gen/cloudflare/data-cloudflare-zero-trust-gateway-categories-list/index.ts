// https://registry.terraform.io/providers/cloudflare/cloudflare/5.21.0/docs/data-sources/zero_trust_gateway_categories_list
...
export class DataCloudflareZeroTrustGatewayCategoriesListResultSubcategoriesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataCloudflareZeroTrustGatewayCategoriesListResultSubcategories | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataCloudflareZeroTrustGatewayCategoriesListResultSubcategories | undefined) {
    if (value === undefined) {
...
export class DataCloudflareZeroTrustGatewayCategoriesListResultOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataCloudflareZeroTrustGatewayCategoriesListResult | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataCloudflareZeroTrustGatewayCategoriesListResult | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
  ...
  private _subcategories = new DataCloudflareZeroTrustGatewayCategoriesListResultSubcategoriesList(this, "subcategories", false);
...
export class DataCloudflareZeroTrustGatewayCategoriesList extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "cloudflare_zero_trust_gateway_categories_list";
  ...
  * @param importFromId The id of the existing DataCloudflareZeroTrustGatewayCategoriesList that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.21.0/docs/data-sources/zero_trust_gateway_categories_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.21.0/docs/data-sources/zero_trust_gateway_categories_list cloudflare_zero_trust_gateway_categories_list} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataCloudflareZeroTrustGatewayCategoriesListConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataCloudflareZeroTrustGatewayCategoriesListConfig = {}) {
    super(scope, id, {
  ...
  private _result = new DataCloudflareZeroTrustGatewayCategoriesListResultList(this, "result", false);
  public get result() {
    return this._result;
  }

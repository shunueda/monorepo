// https://registry.terraform.io/providers/cloudflare/cloudflare/5.21.0/docs/data-sources/pipeline
...
export function dataCloudflarePipelineTablesToTerraform(struct?: DataCloudflarePipelineTables): any {
...
export function dataCloudflarePipelineTablesToHclTerraform(struct?: DataCloudflarePipelineTables): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataCloudflarePipelineTablesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataCloudflarePipelineTables | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataCloudflarePipelineTables | undefined) {
    if (value === undefined) {
...
export class DataCloudflarePipelineTablesList extends cdktf.ComplexList {
...
*/
export class DataCloudflarePipeline extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "cloudflare_pipeline";
  ...
  * @param importFromId The id of the existing DataCloudflarePipeline that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.21.0/docs/data-sources/pipeline#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_pipeline", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.21.0/docs/data-sources/pipeline cloudflare_pipeline} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataCloudflarePipelineConfig
  */
  public constructor(scope: Construct, id: string, config: DataCloudflarePipelineConfig) {
    super(scope, id, {
  ...
  private _tables = new DataCloudflarePipelineTablesList(this, "tables", false);
  public get tables() {
    return this._tables;
  }

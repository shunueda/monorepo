...
export function dataCloudflareUserGroupFilterToTerraform(struct?: DataCloudflareUserGroupFilter | cdktf.IResolvable): any {
...
export function dataCloudflareUserGroupFilterToHclTerraform(struct?: DataCloudflareUserGroupFilter | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataCloudflareUserGroupFilterOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataCloudflareUserGroupFilter | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataCloudflareUserGroupFilter | cdktf.IResolvable | undefined) {
    if (value === undefined) {

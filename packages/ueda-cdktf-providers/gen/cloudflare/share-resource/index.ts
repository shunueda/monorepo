// https://registry.terraform.io/providers/cloudflare/cloudflare/5.21.1/docs/resources/share_resource
...
export class ShareResource extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ShareResource that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.21.1/docs/resources/share_resource#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.21.1/docs/resources/share_resource cloudflare_share_resource} Resource
  *
  * @param scope The scope in which to define this construct

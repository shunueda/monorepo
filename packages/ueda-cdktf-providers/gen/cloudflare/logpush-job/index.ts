// https://registry.terraform.io/providers/cloudflare/cloudflare/5.22.0/docs/resources/logpush_job
...
export class LogpushJobOutputOptionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _mergeSubrequests?: boolean | cdktf.IResolvable; 
  public get mergeSubrequests() {
    return this.getBooleanAttribute('merge_subrequests');
  }
  public set mergeSubrequests(value: boolean | cdktf.IResolvable) {
    this._mergeSubrequests = value;
  }
  public resetMergeSubrequests() {
    this._mergeSubrequests = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get mergeSubrequestsInput() {
...
export class LogpushJob extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LogpushJob that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.22.0/docs/resources/logpush_job#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.22.0/docs/resources/logpush_job cloudflare_logpush_job} Resource
  *
  * @param scope The scope in which to define this construct

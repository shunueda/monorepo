// https://registry.terraform.io/providers/cloudflare/cloudflare/5.24.0/docs/resources/ai_gateway
...
export interface AiGatewayConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  readonly logClassification?: boolean | cdktf.IResolvable;
  /**
...
export class AiGateway extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AiGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.24.0/docs/resources/ai_gateway#import import section} in the documentation of this resource for the id to use
  ...
  */
  public constructor(scope: Construct, id: string, config: AiGatewayConfig) {
    ...
    this._id = config.id;
    this._logClassification = config.logClassification;
  ...
  // log_classification - computed: false, optional: true, required: false
  private _logClassification?: boolean | cdktf.IResolvable; 
  public get logClassification() {
    return this.getBooleanAttribute('log_classification');
  }
  public set logClassification(value: boolean | cdktf.IResolvable) {
    this._logClassification = value;
  }
  public resetLogClassification() {
    this._logClassification = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get logClassificationInput() {
    return this._logClassification;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      log_classification: cdktf.booleanToTerraform(this._logClassification),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      log_classification: {
        value: cdktf.booleanToHclTerraform(this._logClassification),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },

// https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/resources/stream_live_input
...
export function streamLiveInputPlaybackToTerraform(struct?: StreamLiveInputPlayback): any {
...
export function streamLiveInputPlaybackToHclTerraform(struct?: StreamLiveInputPlayback): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class StreamLiveInputPlaybackOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): StreamLiveInputPlayback | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: StreamLiveInputPlayback | undefined) {
    if (value === undefined) {
...
export class StreamLiveInput extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StreamLiveInput that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/resources/stream_live_input#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _playback = new StreamLiveInputPlaybackOutputReference(this, "playback");
  public get playback() {

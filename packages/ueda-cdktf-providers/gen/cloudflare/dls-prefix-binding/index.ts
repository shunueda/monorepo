// https://registry.terraform.io/providers/cloudflare/cloudflare/5.23.0/docs/resources/dls_prefix_binding
...
export class DlsPrefixBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DlsPrefixBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.23.0/docs/resources/dls_prefix_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.23.0/docs/resources/dls_prefix_binding cloudflare_dls_prefix_binding} Resource
  *
  * @param scope The scope in which to define this construct

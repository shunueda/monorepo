// https://registry.terraform.io/providers/cloudflare/cloudflare/5.21.0/docs/resources/zero_trust_tunnel_cloudflared_config
...
export class ZeroTrustTunnelCloudflaredConfigConfigIngressOriginRequestOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _matchSnItoHost?: boolean | cdktf.IResolvable; 
  public get matchSnItoHost() {
    return this.getBooleanAttribute('match_sn_ito_host');
  }
  public set matchSnItoHost(value: boolean | cdktf.IResolvable) {
    this._matchSnItoHost = value;
  }
  public resetMatchSnItoHost() {
    this._matchSnItoHost = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get matchSnItoHostInput() {
...
export class ZeroTrustTunnelCloudflaredConfigA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ZeroTrustTunnelCloudflaredConfigA that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.21.0/docs/resources/zero_trust_tunnel_cloudflared_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.21.0/docs/resources/zero_trust_tunnel_cloudflared_config cloudflare_zero_trust_tunnel_cloudflared_config} Resource
  *
  * @param scope The scope in which to define this construct

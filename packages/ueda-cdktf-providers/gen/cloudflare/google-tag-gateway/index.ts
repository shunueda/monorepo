// https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/resources/google_tag_gateway
...
export class GoogleTagGateway extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleTagGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/resources/google_tag_gateway#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/resources/google_tag_gateway cloudflare_google_tag_gateway} Resource
  *
  * @param scope The scope in which to define this construct

...
export function magicWanGreTunnelBgpToTerraform(struct?: MagicWanGreTunnelBgp | cdktf.IResolvable): any {
...
export function magicWanGreTunnelBgpToHclTerraform(struct?: MagicWanGreTunnelBgp | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class MagicWanGreTunnelBgpOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): MagicWanGreTunnelBgp | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: MagicWanGreTunnelBgp | cdktf.IResolvable | undefined) {
    if (value === undefined) {

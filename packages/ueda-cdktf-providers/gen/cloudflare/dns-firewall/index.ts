// https://registry.terraform.io/providers/cloudflare/cloudflare/5.21.1/docs/resources/dns_firewall
...
export class DnsFirewall extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DnsFirewall that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.21.1/docs/resources/dns_firewall#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.21.1/docs/resources/dns_firewall cloudflare_dns_firewall} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: DnsFirewallConfig) {
    ...
    this._dnsFirewallIpCount = config.dnsFirewallIpCount;
  ...
  // dns_firewall_ip_count - computed: true, optional: true, required: false
  private _dnsFirewallIpCount?: number; 
  public get dnsFirewallIpCount() {
    return this.getNumberAttribute('dns_firewall_ip_count');
  }
  public set dnsFirewallIpCount(value: number) {
    this._dnsFirewallIpCount = value;
  }
  public resetDnsFirewallIpCount() {
    this._dnsFirewallIpCount = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get dnsFirewallIpCountInput() {
    return this._dnsFirewallIpCount;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      dns_firewall_ip_count: cdktf.numberToTerraform(this._dnsFirewallIpCount),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      dns_firewall_ip_count: {
        value: cdktf.numberToHclTerraform(this._dnsFirewallIpCount),
        isBlock: false,
        type: "simple",

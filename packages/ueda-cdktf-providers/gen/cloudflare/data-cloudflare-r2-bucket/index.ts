// https://registry.terraform.io/providers/cloudflare/cloudflare/5.24.0/docs/data-sources/r2_bucket
...
export interface DataCloudflareR2BucketConfig extends cdktf.TerraformMetaArguments {
  ...
  * Account ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.24.0/docs/data-sources/r2_bucket#account_id DataCloudflareR2Bucket#account_id}
  */
  readonly accountId?: string;
  /**
  * Name of the bucket.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.24.0/docs/data-sources/r2_bucket#bucket_name DataCloudflareR2Bucket#bucket_name}
  */
...
export class DataCloudflareR2Bucket extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareR2Bucket that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.24.0/docs/data-sources/r2_bucket#import import section} in the documentation of this resource for the id to use

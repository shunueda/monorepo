// https://registry.terraform.io/providers/cloudflare/cloudflare/5.23.0/docs/resources/origin_tls_compliance_modes
...
export class OriginTlsComplianceModes extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OriginTlsComplianceModes that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.23.0/docs/resources/origin_tls_compliance_modes#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.23.0/docs/resources/origin_tls_compliance_modes cloudflare_origin_tls_compliance_modes} Resource
  *
  * @param scope The scope in which to define this construct

// https://registry.terraform.io/providers/cloudflare/cloudflare/5.21.1/docs/data-sources/firewall_rules
...
export function dataCloudflareFirewallRulesResultFilterToTerraform(struct?: DataCloudflareFirewallRulesResultFilter): any {
...
export function dataCloudflareFirewallRulesResultFilterToHclTerraform(struct?: DataCloudflareFirewallRulesResultFilter): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataCloudflareFirewallRulesResultFilterOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataCloudflareFirewallRulesResultFilter | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataCloudflareFirewallRulesResultFilter | undefined) {
    if (value === undefined) {
...
export function dataCloudflareFirewallRulesResultToTerraform(struct?: DataCloudflareFirewallRulesResult): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataCloudflareFirewallRulesResultToHclTerraform(struct?: DataCloudflareFirewallRulesResult): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataCloudflareFirewallRulesResultOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataCloudflareFirewallRulesResult | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataCloudflareFirewallRulesResult | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
  ...
  private _filter = new DataCloudflareFirewallRulesResultFilterOutputReference(this, "filter");
  public get filter() {
    return this._filter;
  }
...
export class DataCloudflareFirewallRules extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "cloudflare_firewall_rules";
  ...
  * @param importFromId The id of the existing DataCloudflareFirewallRules that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.21.1/docs/data-sources/firewall_rules#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.21.1/docs/data-sources/firewall_rules cloudflare_firewall_rules} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _result = new DataCloudflareFirewallRulesResultList(this, "result", false);
  public get result() {
    return this._result;
  }

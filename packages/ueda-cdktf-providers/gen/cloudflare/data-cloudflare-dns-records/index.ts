// https://registry.terraform.io/providers/cloudflare/cloudflare/5.23.0/docs/data-sources/dns_records
...
export class DataCloudflareDnsRecords extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareDnsRecords that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.23.0/docs/data-sources/dns_records#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.23.0/docs/data-sources/dns_records cloudflare_dns_records} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: DataCloudflareDnsRecordsConfig = {}) {
    ...
    this._shadowedByName = config.shadowedByName;
    this._shadowingName = config.shadowingName;
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      shadowed_by_name: cdktf.stringToTerraform(this._shadowedByName),
      shadowing_name: cdktf.stringToTerraform(this._shadowingName),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      shadowed_by_name: {
        value: cdktf.stringToHclTerraform(this._shadowedByName),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      shadowing_name: {
        value: cdktf.stringToHclTerraform(this._shadowingName),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },

// https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.79/docs/data-sources/guardrail_key_assignments
...
/**
* Represents a {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.79/docs/data-sources/guardrail_key_assignments openrouter_guardrail_key_assignments}
*/
export class DataOpenrouterGuardrailKeyAssignments extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpenrouterGuardrailKeyAssignments that should be imported. Refer to the {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.79/docs/data-sources/guardrail_key_assignments#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.79/docs/data-sources/guardrail_key_assignments openrouter_guardrail_key_assignments} Data Source
  *
  * @param scope The scope in which to define this construct

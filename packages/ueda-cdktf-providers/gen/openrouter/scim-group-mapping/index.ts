// https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.123/docs/resources/scim_group_mapping
...
export interface ScimGroupMappingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.123/docs/resources/scim_group_mapping#boolean ScimGroupMapping#boolean}
  */
  readonly boolean?: boolean | cdktf.IResolvable;
  /**
  * must be one of ["true", "false"]
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.123/docs/resources/scim_group_mapping#keep_members_enum ScimGroupMapping#keep_members_enum}
  */
  readonly keepMembersEnum?: string;
  /**
  * must be one of ["admin", "member"]
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.123/docs/resources/scim_group_mapping#role ScimGroupMapping#role}
  */
  readonly role: string;
  /**
  * Requires replacement if changed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.123/docs/resources/scim_group_mapping#scim_group_id ScimGroupMapping#scim_group_id}
  */
  readonly scimGroupId: string;
  /**
  * Requires replacement if changed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.123/docs/resources/scim_group_mapping#workspace_id ScimGroupMapping#workspace_id}
  */
  readonly workspaceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.123/docs/resources/scim_group_mapping openrouter_scim_group_mapping}
*/
export class ScimGroupMapping extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ScimGroupMapping that should be imported. Refer to the {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.123/docs/resources/scim_group_mapping#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.123/docs/resources/scim_group_mapping openrouter_scim_group_mapping} Resource
  *
  * @param scope The scope in which to define this construct

// https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.123/docs/data-sources/scim_group_mapping
...
export interface DataOpenrouterScimGroupMappingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.123/docs/data-sources/scim_group_mapping#id DataOpenrouterScimGroupMapping#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.123/docs/data-sources/scim_group_mapping openrouter_scim_group_mapping}
*/
export class DataOpenrouterScimGroupMapping extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpenrouterScimGroupMapping that should be imported. Refer to the {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.123/docs/data-sources/scim_group_mapping#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.123/docs/data-sources/scim_group_mapping openrouter_scim_group_mapping} Data Source
  *
  * @param scope The scope in which to define this construct

// https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.79/docs/data-sources/workspace
...
export interface DataOpenrouterWorkspaceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.79/docs/data-sources/workspace#id DataOpenrouterWorkspace#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.79/docs/data-sources/workspace openrouter_workspace}
*/
export class DataOpenrouterWorkspace extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpenrouterWorkspace that should be imported. Refer to the {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.79/docs/data-sources/workspace#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.79/docs/data-sources/workspace openrouter_workspace} Data Source
  *
  * @param scope The scope in which to define this construct

// https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.126/docs/data-sources/api_keys
...
export interface DataOpenrouterApiKeysConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.126/docs/data-sources/api_keys#include_disabled DataOpenrouterApiKeys#include_disabled}
  */
  readonly includeDisabled?: string;
  /**
  * Number of API keys to skip for pagination
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.126/docs/data-sources/api_keys#offset DataOpenrouterApiKeys#offset}
  */
  readonly offset?: number;
  /**
  * Filter API keys by workspace ID. By default, keys in the default workspace are returned.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.126/docs/data-sources/api_keys#workspace_id DataOpenrouterApiKeys#workspace_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.126/docs/data-sources/api_keys openrouter_api_keys}
*/
export class DataOpenrouterApiKeys extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpenrouterApiKeys that should be imported. Refer to the {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.126/docs/data-sources/api_keys#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.126/docs/data-sources/api_keys openrouter_api_keys} Data Source
  *
  * @param scope The scope in which to define this construct

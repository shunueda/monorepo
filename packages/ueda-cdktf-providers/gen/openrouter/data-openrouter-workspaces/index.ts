// https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.30/docs/data-sources/workspaces
...
/**
* Represents a {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.30/docs/data-sources/workspaces openrouter_workspaces}
*/
export class DataOpenrouterWorkspaces extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpenrouterWorkspaces that should be imported. Refer to the {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.30/docs/data-sources/workspaces#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.30/docs/data-sources/workspaces openrouter_workspaces} Data Source
  *
  * @param scope The scope in which to define this construct

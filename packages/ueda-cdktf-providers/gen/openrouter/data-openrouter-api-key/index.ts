// https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.126/docs/data-sources/api_key
...
export interface DataOpenrouterApiKeyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.126/docs/data-sources/api_key#hash DataOpenrouterApiKey#hash}
  */
  readonly hash: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.126/docs/data-sources/api_key openrouter_api_key}
*/
export class DataOpenrouterApiKey extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpenrouterApiKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.126/docs/data-sources/api_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.126/docs/data-sources/api_key openrouter_api_key} Data Source
  *
  * @param scope The scope in which to define this construct

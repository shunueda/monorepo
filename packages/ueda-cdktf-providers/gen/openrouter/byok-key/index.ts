// https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.79/docs/resources/byok_key
...
export interface ByokKeyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.79/docs/resources/byok_key#allowed_api_key_hashes ByokKey#allowed_api_key_hashes}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.79/docs/resources/byok_key#allowed_models ByokKey#allowed_models}
  */
  readonly allowedModels?: string[];
  /**
  * Optional allowlist of user IDs that may use this credential. `null` means no restriction.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.79/docs/resources/byok_key#allowed_user_ids ByokKey#allowed_user_ids}
  */
  readonly allowedUserIds?: string[];
  /**
  * Whether this credential should be created in a disabled state.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.79/docs/resources/byok_key#disabled ByokKey#disabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.79/docs/resources/byok_key#is_fallback ByokKey#is_fallback}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.79/docs/resources/byok_key#workspace_id ByokKey#workspace_id}
  */
  readonly workspaceId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.79/docs/resources/byok_key openrouter_byok_key}
*/
export class ByokKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ByokKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.79/docs/resources/byok_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.79/docs/resources/byok_key openrouter_byok_key} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: ByokKeyConfig) {
    ...
    this._allowedApiKeyHashes = config.allowedApiKeyHashes;
  ...
  // allowed_api_key_hashes - computed: true, optional: true, required: false
  private _allowedApiKeyHashes?: string[]; 
  public get allowedApiKeyHashes() {
    return this.getListAttribute('allowed_api_key_hashes');
  }
  public set allowedApiKeyHashes(value: string[]) {
    this._allowedApiKeyHashes = value;
  }
  public resetAllowedApiKeyHashes() {
    this._allowedApiKeyHashes = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get allowedApiKeyHashesInput() {
    return this._allowedApiKeyHashes;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      allowed_api_key_hashes: cdktf.listMapper(cdktf.stringToTerraform, false)(this._allowedApiKeyHashes),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      allowed_api_key_hashes: {
        value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(this._allowedApiKeyHashes),
        isBlock: false,
        type: "list",

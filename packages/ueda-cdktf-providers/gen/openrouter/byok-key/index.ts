...
export class ByokKey extends cdktf.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: ByokKeyConfig) {
    ...
    this._isByokOnly = config.isByokOnly;
  ...
  // is_byok_only - computed: true, optional: true, required: false
  private _isByokOnly?: boolean | cdktf.IResolvable; 
  public get isByokOnly() {
    return this.getBooleanAttribute('is_byok_only');
  }
  public set isByokOnly(value: boolean | cdktf.IResolvable) {
    this._isByokOnly = value;
  }
  public resetIsByokOnly() {
    this._isByokOnly = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get isByokOnlyInput() {
    return this._isByokOnly;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      is_byok_only: cdktf.booleanToTerraform(this._isByokOnly),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      is_byok_only: {
        value: cdktf.booleanToHclTerraform(this._isByokOnly),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },

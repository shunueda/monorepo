// https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.103/docs
...
export interface OpenrouterProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.103/docs#api_key OpenrouterProvider#api_key}
  */
  readonly apiKey?: string;
  /**
  * Server URL (defaults to https://openrouter.ai/api/v1)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.103/docs#server_url OpenrouterProvider#server_url}
  */
  readonly serverUrl?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.103/docs#alias OpenrouterProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.103/docs openrouter}
*/
export class OpenrouterProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing OpenrouterProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.103/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.103/docs openrouter} Resource
  *
  * @param scope The scope in which to define this construct

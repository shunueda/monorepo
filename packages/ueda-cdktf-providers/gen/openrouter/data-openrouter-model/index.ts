// https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.43/docs/data-sources/model
...
export interface DataOpenrouterModelConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.43/docs/data-sources/model#author DataOpenrouterModel#author}
  */
  readonly author: string;
  /**
  * The model slug, optionally including a variant suffix (e.g. gpt-4 or gpt-4:free)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.43/docs/data-sources/model#slug DataOpenrouterModel#slug}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.43/docs/data-sources/model openrouter_model}
*/
export class DataOpenrouterModel extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpenrouterModel that should be imported. Refer to the {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.43/docs/data-sources/model#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.43/docs/data-sources/model openrouter_model} Data Source
  *
  * @param scope The scope in which to define this construct

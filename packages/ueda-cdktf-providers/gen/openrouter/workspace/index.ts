// https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.103/docs/resources/workspace
...
export interface WorkspaceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Required to delete the default workspace. Deleting it permanently disables the account’s unscoped inference API keys (management/provisioning keys are retained) and its budgets, guardrails, classifiers, and broadcast destinations. Ignored for non-default workspaces. must be one of ["true", "false"]
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.103/docs/resources/workspace#confirm_default_workspace_deletion Workspace#confirm_default_workspace_deletion}
  */
  readonly confirmDefaultWorkspaceDeletion?: string;
  /**
  * Default image model for this workspace
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.103/docs/resources/workspace#default_image_model Workspace#default_image_model}
  */
  readonly defaultImageModel?: string;
  /**
  * Default provider sort preference (price, throughput, latency, exacto)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.103/docs/resources/workspace#default_provider_sort Workspace#default_provider_sort}
  */
  readonly defaultProviderSort?: string;
  /**
  * Default text model for this workspace
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.103/docs/resources/workspace#default_text_model Workspace#default_text_model}
  */
  readonly defaultTextModel?: string;
  /**
  * Description of the workspace
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.103/docs/resources/workspace#description Workspace#description}
  */
  readonly description?: string;
  /**
  * Optional array of API key IDs to filter I/O logging
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.103/docs/resources/workspace#io_logging_api_key_ids Workspace#io_logging_api_key_ids}
  */
  readonly ioLoggingApiKeyIds?: number[];
  /**
  * Sampling rate for I/O logging (0.0001-1)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.103/docs/resources/workspace#io_logging_sampling_rate Workspace#io_logging_sampling_rate}
  */
  readonly ioLoggingSamplingRate?: number;
  /**
  * Whether data discount logging is enabled
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.103/docs/resources/workspace#is_data_discount_logging_enabled Workspace#is_data_discount_logging_enabled}
  */
  readonly isDataDiscountLoggingEnabled?: boolean | cdktf.IResolvable;
  /**
  * Whether broadcast is enabled
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.103/docs/resources/workspace#is_observability_broadcast_enabled Workspace#is_observability_broadcast_enabled}
  */
  readonly isObservabilityBroadcastEnabled?: boolean | cdktf.IResolvable;
  /**
  * Whether private logging is enabled
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.103/docs/resources/workspace#is_observability_io_logging_enabled Workspace#is_observability_io_logging_enabled}
  */
  readonly isObservabilityIoLoggingEnabled?: boolean | cdktf.IResolvable;
  /**
  * Name for the new workspace
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.103/docs/resources/workspace#name Workspace#name}
  */
  readonly name: string;
  /**
  * URL-friendly slug (lowercase alphanumeric segments separated by single hyphens, no leading/trailing hyphens)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.103/docs/resources/workspace#slug Workspace#slug}
  */
  readonly slug: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.103/docs/resources/workspace openrouter_workspace}
*/
export class Workspace extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Workspace that should be imported. Refer to the {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.103/docs/resources/workspace#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.2.103/docs/resources/workspace openrouter_workspace} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: WorkspaceConfig) {
    ...
    this._confirmDefaultWorkspaceDeletion = config.confirmDefaultWorkspaceDeletion;
  ...
  // confirm_default_workspace_deletion - computed: false, optional: true, required: false
  private _confirmDefaultWorkspaceDeletion?: string; 
  public get confirmDefaultWorkspaceDeletion() {
    return this.getStringAttribute('confirm_default_workspace_deletion');
  }
  public set confirmDefaultWorkspaceDeletion(value: string) {
    this._confirmDefaultWorkspaceDeletion = value;
  }
  public resetConfirmDefaultWorkspaceDeletion() {
    this._confirmDefaultWorkspaceDeletion = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get confirmDefaultWorkspaceDeletionInput() {
    return this._confirmDefaultWorkspaceDeletion;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      confirm_default_workspace_deletion: cdktf.stringToTerraform(this._confirmDefaultWorkspaceDeletion),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      confirm_default_workspace_deletion: {
        value: cdktf.stringToHclTerraform(this._confirmDefaultWorkspaceDeletion),
        isBlock: false,
        type: "simple",

// https://registry.terraform.io/providers/openrouterteam/openrouter/0.1.32/docs/data-sources/guardrail
...
export interface DataOpenrouterGuardrailConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.1.32/docs/data-sources/guardrail#id DataOpenrouterGuardrail#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.1.32/docs/data-sources/guardrail openrouter_guardrail}
*/
export class DataOpenrouterGuardrail extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpenrouterGuardrail that should be imported. Refer to the {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.1.32/docs/data-sources/guardrail#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.1.32/docs/data-sources/guardrail openrouter_guardrail} Data Source
  *
  * @param scope The scope in which to define this construct

// https://registry.terraform.io/providers/openrouterteam/openrouter/0.1.32/docs/data-sources/byok_keys
...
export interface DataOpenrouterByokKeysConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.1.32/docs/data-sources/byok_keys#provider_slug DataOpenrouterByokKeys#provider_slug}
  */
  readonly providerSlug?: string;
  /**
  * Optional workspace ID to filter by. Defaults to the authenticated entity's default workspace.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.1.32/docs/data-sources/byok_keys#workspace_id DataOpenrouterByokKeys#workspace_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.1.32/docs/data-sources/byok_keys openrouter_byok_keys}
*/
export class DataOpenrouterByokKeys extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpenrouterByokKeys that should be imported. Refer to the {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.1.32/docs/data-sources/byok_keys#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/openrouterteam/openrouter/0.1.32/docs/data-sources/byok_keys openrouter_byok_keys} Data Source
  *
  * @param scope The scope in which to define this construct

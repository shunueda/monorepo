...
export function dataGithubOrganizationAppInstallationsInstallationsToTerraform(struct?: DataGithubOrganizationAppInstallationsInstallations): any {
...
export function dataGithubOrganizationAppInstallationsInstallationsToHclTerraform(struct?: DataGithubOrganizationAppInstallationsInstallations): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataGithubOrganizationAppInstallationsInstallationsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataGithubOrganizationAppInstallationsInstallations | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataGithubOrganizationAppInstallationsInstallations | undefined) {
    if (value === undefined) {
...
export class DataGithubOrganizationAppInstallations extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "github_organization_app_installations";
  ...
  */
  public constructor(scope: Construct, id: string, config: DataGithubOrganizationAppInstallationsConfig = {}) {
    super(scope, id, {
  ...
  private _installations = new DataGithubOrganizationAppInstallationsInstallationsList(this, "installations", false);

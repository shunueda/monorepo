// https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset
...
export interface RepositoryRulesetConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#enforcement RepositoryRuleset#enforcement}
  */
  readonly enforcement: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#id RepositoryRuleset#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#name RepositoryRuleset#name}
  */
  readonly name: string;
  /**
  * Name of the repository to apply ruleset to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#repository RepositoryRuleset#repository}
  */
  readonly repository: string;
  /**
  * Possible values are branch, push and tag
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#target RepositoryRuleset#target}
  */
  readonly target: string;
  /**
  * bypass_actors block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#bypass_actors RepositoryRuleset#bypass_actors}
  */
  readonly bypassActors?: RepositoryRulesetBypassActors[] | cdktf.IResolvable;
  /**
  * conditions block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#conditions RepositoryRuleset#conditions}
  */
  readonly conditions?: RepositoryRulesetConditions;
  /**
  * rules block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#rules RepositoryRuleset#rules}
  */
  readonly rules: RepositoryRulesetRules;
}
export interface RepositoryRulesetBypassActors {
  /**
  * The ID of the actor that can bypass a ruleset. If `actor_type` is `Integration`, `actor_id` is a GitHub App ID. When `actor_type` is `User`, this should be set to the numeric GitHub user ID. Some actor types such as `OrganizationAdmin`, `EnterpriseOwner`, and `DeployKey` do not have an ID — this argument should not be set in those cases as the GitHub API will ignore it.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#actor_id RepositoryRuleset#actor_id}
  */
  readonly actorId?: number;
  /**
  * The type of actor that can bypass a ruleset. Can be one of: `RepositoryRole`, `Team`, `Integration`, `OrganizationAdmin`, `DeployKey`, `EnterpriseOwner`, or `User`. See https://docs.github.com/en/rest/repos/rules for more information.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#actor_type RepositoryRuleset#actor_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#bypass_mode RepositoryRuleset#bypass_mode}
  */
...
export interface RepositoryRulesetConditionsRefName {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#exclude RepositoryRuleset#exclude}
  */
  readonly exclude: string[];
  /**
  * Array of ref names or patterns to include. One of these patterns must match for the condition to pass. Also accepts `~DEFAULT_BRANCH` to include the default branch or `~ALL` to include all branches.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#include RepositoryRuleset#include}
  */
...
export interface RepositoryRulesetConditions {
  ...
  * ref_name block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#ref_name RepositoryRuleset#ref_name}
  */
...
export interface RepositoryRulesetRulesBranchNamePattern {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#negate RepositoryRuleset#negate}
  */
  readonly negate?: boolean | cdktf.IResolvable;
  /**
  * The operator to use for matching. Can be one of: `starts_with`, `ends_with`, `contains`, `regex`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#operator RepositoryRuleset#operator}
  */
  readonly operator: string;
  /**
  * The pattern to match with.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#pattern RepositoryRuleset#pattern}
  */
...
export interface RepositoryRulesetRulesCopilotCodeReview {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#review_draft_pull_requests RepositoryRuleset#review_draft_pull_requests}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#review_on_push RepositoryRuleset#review_on_push}
  */
...
export class RepositoryRulesetRulesCopilotCodeReviewOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): RepositoryRulesetRulesCopilotCodeReview | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: RepositoryRulesetRulesCopilotCodeReview | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export interface RepositoryRulesetRulesFileExtensionRestriction {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#restricted_file_extensions RepositoryRuleset#restricted_file_extensions}
  */
...
export interface RepositoryRulesetRulesFilePathRestriction {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#restricted_file_paths RepositoryRuleset#restricted_file_paths}
  */
...
export interface RepositoryRulesetRulesMaxFilePathLength {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#max_file_path_length RepositoryRuleset#max_file_path_length}
  */
...
export interface RepositoryRulesetRulesMaxFileSize {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#max_file_size RepositoryRuleset#max_file_size}
  */
...
export interface RepositoryRulesetRulesMergeQueue {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#check_response_timeout_minutes RepositoryRuleset#check_response_timeout_minutes}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#grouping_strategy RepositoryRuleset#grouping_strategy}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#max_entries_to_build RepositoryRuleset#max_entries_to_build}
  */
  readonly maxEntriesToBuild?: number;
  /**
  * The maximum number of PRs that will be merged together in a group. Defaults to `5`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#max_entries_to_merge RepositoryRuleset#max_entries_to_merge}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#merge_method RepositoryRuleset#merge_method}
  */
  readonly mergeMethod?: string;
  /**
  * The minimum number of PRs that will be merged together in a group. Defaults to `1`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#min_entries_to_merge RepositoryRuleset#min_entries_to_merge}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#min_entries_to_merge_wait_minutes RepositoryRuleset#min_entries_to_merge_wait_minutes}
  */
...
export interface RepositoryRulesetRulesPullRequestRequiredReviewersReviewer {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#type RepositoryRuleset#type}
  */
...
export class RepositoryRulesetRulesPullRequestRequiredReviewersReviewerOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): RepositoryRulesetRulesPullRequestRequiredReviewersReviewer | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: RepositoryRulesetRulesPullRequestRequiredReviewersReviewer | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._id = undefined;
...
export interface RepositoryRulesetRulesPullRequestRequiredReviewers {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#file_patterns RepositoryRuleset#file_patterns}
  */
  readonly filePatterns: string[];
  /**
  * Minimum number of approvals required from this reviewer. Set to 0 to make approval optional.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#minimum_approvals RepositoryRuleset#minimum_approvals}
  */
  readonly minimumApprovals: number;
  /**
  * reviewer block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#reviewer RepositoryRuleset#reviewer}
  */
...
export class RepositoryRulesetRulesPullRequestRequiredReviewersOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _reviewer = new RepositoryRulesetRulesPullRequestRequiredReviewersReviewerOutputReference(this, "reviewer");
  public get reviewer() {
    return this._reviewer;
  }
  public putReviewer(value: RepositoryRulesetRulesPullRequestRequiredReviewersReviewer) {
...
export class RepositoryRulesetRulesPullRequestRequiredReviewersList extends cdktf.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): RepositoryRulesetRulesPullRequestRequiredReviewersOutputReference {
...
export interface RepositoryRulesetRulesPullRequest {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#allowed_merge_methods RepositoryRuleset#allowed_merge_methods}
  */
  readonly allowedMergeMethods?: string[];
  /**
  * New, reviewable commits pushed will dismiss previous pull request review approvals. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#dismiss_stale_reviews_on_push RepositoryRuleset#dismiss_stale_reviews_on_push}
  */
  readonly dismissStaleReviewsOnPush?: boolean | cdktf.IResolvable;
  /**
  * Require an approving review in pull requests that modify files that have a designated code owner. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#require_code_owner_review RepositoryRuleset#require_code_owner_review}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#require_last_push_approval RepositoryRuleset#require_last_push_approval}
  */
  readonly requireLastPushApproval?: boolean | cdktf.IResolvable;
  /**
  * The number of approving reviews that are required before a pull request can be merged. Defaults to `0`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#required_approving_review_count RepositoryRuleset#required_approving_review_count}
  */
  readonly requiredApprovingReviewCount?: number;
  /**
  * All conversations on code must be resolved before a pull request can be merged. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#required_review_thread_resolution RepositoryRuleset#required_review_thread_resolution}
  */
  readonly requiredReviewThreadResolution?: boolean | cdktf.IResolvable;
  /**
  * required_reviewers block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#required_reviewers RepositoryRuleset#required_reviewers}
  */
...
export class RepositoryRulesetRulesPullRequestOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _requiredReviewers = new RepositoryRulesetRulesPullRequestRequiredReviewersList(this, "required_reviewers", false);
...
export interface RepositoryRulesetRulesRequiredCodeScanningRequiredCodeScanningTool {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#alerts_threshold RepositoryRuleset#alerts_threshold}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#security_alerts_threshold RepositoryRuleset#security_alerts_threshold}
  */
  readonly securityAlertsThreshold: string;
  /**
  * The name of a code scanning tool
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#tool RepositoryRuleset#tool}
  */
...
export interface RepositoryRulesetRulesRequiredCodeScanning {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#required_code_scanning_tool RepositoryRuleset#required_code_scanning_tool}
  */
...
export interface RepositoryRulesetRulesRequiredDeployments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#required_deployment_environments RepositoryRuleset#required_deployment_environments}
  */
...
export interface RepositoryRulesetRulesRequiredStatusChecksRequiredCheck {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#context RepositoryRuleset#context}
  */
  readonly context: string;
  /**
  * The optional integration ID that this status check must originate from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#integration_id RepositoryRuleset#integration_id}
  */
...
export interface RepositoryRulesetRulesRequiredStatusChecks {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#do_not_enforce_on_create RepositoryRuleset#do_not_enforce_on_create}
  */
  readonly doNotEnforceOnCreate?: boolean | cdktf.IResolvable;
  /**
  * Whether pull requests targeting a matching branch must be tested with the latest code. This setting will not take effect unless at least one status check is enabled. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#strict_required_status_checks_policy RepositoryRuleset#strict_required_status_checks_policy}
  */
  readonly strictRequiredStatusChecksPolicy?: boolean | cdktf.IResolvable;
  /**
  * required_check block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#required_check RepositoryRuleset#required_check}
  */
...
export interface RepositoryRulesetRules {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#creation RepositoryRuleset#creation}
  */
  readonly creation?: boolean | cdktf.IResolvable;
  /**
  * Only allow users with bypass permissions to delete matching refs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#deletion RepositoryRuleset#deletion}
  */
  readonly deletion?: boolean | cdktf.IResolvable;
  /**
  * Prevent users with push access from force pushing to branches.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#non_fast_forward RepositoryRuleset#non_fast_forward}
  */
  readonly nonFastForward?: boolean | cdktf.IResolvable;
  /**
  * Prevent merge commits from being pushed to matching branches.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#required_linear_history RepositoryRuleset#required_linear_history}
  */
  readonly requiredLinearHistory?: boolean | cdktf.IResolvable;
  /**
  * Commits pushed to matching branches must have verified signatures.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#required_signatures RepositoryRuleset#required_signatures}
  */
  readonly requiredSignatures?: boolean | cdktf.IResolvable;
  /**
  * Only allow users with bypass permission to update matching refs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#update RepositoryRuleset#update}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#update_allows_fetch_and_merge RepositoryRuleset#update_allows_fetch_and_merge}
  */
  readonly updateAllowsFetchAndMerge?: boolean | cdktf.IResolvable;
  /**
  * branch_name_pattern block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#branch_name_pattern RepositoryRuleset#branch_name_pattern}
  */
  readonly branchNamePattern?: RepositoryRulesetRulesBranchNamePattern;
  /**
  * commit_author_email_pattern block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#commit_author_email_pattern RepositoryRuleset#commit_author_email_pattern}
  */
  readonly commitAuthorEmailPattern?: RepositoryRulesetRulesCommitAuthorEmailPattern;
  /**
  * commit_message_pattern block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#commit_message_pattern RepositoryRuleset#commit_message_pattern}
  */
  readonly commitMessagePattern?: RepositoryRulesetRulesCommitMessagePattern;
  /**
  * committer_email_pattern block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#committer_email_pattern RepositoryRuleset#committer_email_pattern}
  */
  readonly committerEmailPattern?: RepositoryRulesetRulesCommitterEmailPattern;
  /**
  * copilot_code_review block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#copilot_code_review RepositoryRuleset#copilot_code_review}
  */
  readonly copilotCodeReview?: RepositoryRulesetRulesCopilotCodeReview;
  /**
  * file_extension_restriction block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#file_extension_restriction RepositoryRuleset#file_extension_restriction}
  */
  readonly fileExtensionRestriction?: RepositoryRulesetRulesFileExtensionRestriction;
  /**
  * file_path_restriction block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#file_path_restriction RepositoryRuleset#file_path_restriction}
  */
  ...
  * merge_queue block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#merge_queue RepositoryRuleset#merge_queue}
  */
  readonly mergeQueue?: RepositoryRulesetRulesMergeQueue;
  /**
  * pull_request block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#pull_request RepositoryRuleset#pull_request}
  */
  readonly pullRequest?: RepositoryRulesetRulesPullRequest;
  /**
  * required_code_scanning block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#required_code_scanning RepositoryRuleset#required_code_scanning}
  */
  readonly requiredCodeScanning?: RepositoryRulesetRulesRequiredCodeScanning;
  /**
  * required_deployments block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#required_deployments RepositoryRuleset#required_deployments}
  */
  readonly requiredDeployments?: RepositoryRulesetRulesRequiredDeployments;
  /**
  * required_status_checks block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#required_status_checks RepositoryRuleset#required_status_checks}
  */
  readonly requiredStatusChecks?: RepositoryRulesetRulesRequiredStatusChecks;
  /**
  * tag_name_pattern block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#tag_name_pattern RepositoryRuleset#tag_name_pattern}
  */
...
export class RepositoryRulesetRulesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _copilotCodeReview = new RepositoryRulesetRulesCopilotCodeReviewOutputReference(this, "copilot_code_review");
  public get copilotCodeReview() {
    return this._copilotCodeReview;
  }
  public putCopilotCodeReview(value: RepositoryRulesetRulesCopilotCodeReview) {
...
/**
* Represents a {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset github_repository_ruleset}
*/
export class RepositoryRuleset extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RepositoryRuleset that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/repository_ruleset github_repository_ruleset} Resource
  *
  * @param scope The scope in which to define this construct

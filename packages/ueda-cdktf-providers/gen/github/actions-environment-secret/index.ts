// https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/actions_environment_secret
...
export class ActionsEnvironmentSecret extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ActionsEnvironmentSecret that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/actions_environment_secret#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/actions_environment_secret github_actions_environment_secret} Resource
  *
  * @param scope The scope in which to define this construct

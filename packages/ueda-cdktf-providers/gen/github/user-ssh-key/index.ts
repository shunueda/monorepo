// https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/user_ssh_key
...
export class UserSshKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserSshKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/user_ssh_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/user_ssh_key github_user_ssh_key} Resource
  *
  * @param scope The scope in which to define this construct

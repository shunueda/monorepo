// https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/organization_role_team
...
export interface OrganizationRoleTeamConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/organization_role_team#id OrganizationRoleTeam#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/organization_role_team#role_id OrganizationRoleTeam#role_id}
  */
  readonly roleId: number;
  /**
  * The slug of the team name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/organization_role_team#team_slug OrganizationRoleTeam#team_slug}
  */
  readonly teamSlug: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/organization_role_team github_organization_role_team}
*/
export class OrganizationRoleTeam extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrganizationRoleTeam that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/organization_role_team#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/integrations/github/6.13.0/docs/resources/organization_role_team github_organization_role_team} Resource
  *
  * @param scope The scope in which to define this construct

...
export class ActionsOrganizationWorkflowPermissions extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "github_actions_organization_workflow_permissions";
  ...
  */
  public constructor(scope: Construct, id: string, config: ActionsOrganizationWorkflowPermissionsConfig) {
    super(scope, id, {
